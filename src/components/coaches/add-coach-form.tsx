...
import { Loader2, Camera, RefreshCcw, Fingerprint, Upload, Calendar as CalendarIcon, FileText, Trash2, PlusCircle, Link as LinkIcon, ShieldCheck, User, Mail, Phone, MapPin } from "lucide-react";
              ...
              <div className="space-y-6 bg-slate-50/50 p-6 rounded-2xl border">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <FormField control={form.control} name="specialty" render={({ field }) => (
                        <FormItem><FormLabel>Spécialité</FormLabel><FormControl><Input placeholder="Ex: Entraîneur Principal" {...field} /></FormControl></FormItem>
                      )} />
                      <FormField control={form.control} name="professionalId" render={({ field }) => (
                        <FormItem><FormLabel>ID Professionnel (Optionnel)</FormLabel><FormControl><Input {...field} /></FormControl></FormItem>
                      )} />
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-6 bg-slate-50/50 p-6 rounded-2xl border">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <FormField control={form.control} name="email" render={({ field }) => (
                        <FormItem><FormLabel>Email professionnel</FormLabel><FormControl><Input type="email" {...field} /></FormControl><FormMessage /></FormItem>
                      )} />
                      <FormField control={form.control} name="phone" render={({ field }) => (
                        <FormItem><FormLabel>Téléphone mobile</FormLabel><FormControl><Input type="tel" {...field} /></FormControl><FormMessage /></FormItem>
                      )} />
                  </div>
        ...
        <div className="p-5 border-2 rounded-2xl bg-white space-y-4 relative group shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <FormField control={form.control} name={`documents.${index}.name`} render={({ field }) => (
                    <FormItem><FormLabel>Désignation</FormLabel><FormControl><Input placeholder="Ex: Diplôme, CIN..." {...field} /></FormControl></FormItem>
                )} />
