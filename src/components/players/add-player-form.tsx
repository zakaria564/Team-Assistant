        ...
        <div className="p-3 border-2 rounded-2xl bg-background border-slate-100 space-y-3 relative group shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <FormField control={form.control} name={`documents.${index}.name`} render={({ field }) => (
                    <FormItem><FormLabel className="font-bold text-[10px] uppercase text-slate-500">Désignation</FormLabel><FormControl><Input placeholder="Ex: Licence, CIN..." {...field} className="h-9 bg-background border-slate-200" /></FormControl></FormItem>
                )} />
