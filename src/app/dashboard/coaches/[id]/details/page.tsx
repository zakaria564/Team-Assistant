       ...
       <div className="w-full max-w-2xl space-y-4 text-center">
        ...
        <div className="w-full overflow-x-auto pb-8 scrollbar-thin bg-muted/20 rounded-xl p-2">
            <div className="min-w-[595px] flex justify-center">
                <div id="printable-details" className="bg-white text-slate-900 border shadow-2xl flex flex-col" style={{ width: '595px', height: '842px' }}>
                    <header className="p-4 bg-slate-900 text-white flex flex-row justify-between items-center gap-4 border-b-4 border-primary shrink-0">
                        ...
                        <div className="text-right space-y-0.5">
                            ...
                            <div className="pt-0.5">
                                <p className="text-primary font-black text-[6px] uppercase tracking-[0.2em]">OFFICIELLE ENTRAÎNEUR</p>
                    ...
                    <div className="px-6 py-4 flex-grow flex flex-col">
                        <section className="flex flex-row items-center gap-6 mb-4 bg-slate-50 p-3 rounded-xl border border-slate-100 shadow-sm">
                            ...
                            <div className="flex-1 min-w-0 text-left">
                                <h1 className="text-base font-black text-slate-900 uppercase tracking-tighter leading-none mb-2 break-words">{coach.name}</h1>
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="flex flex-col items-center justify-center text-center p-1 bg-white rounded-lg border border-slate-100 shadow-sm">
                                        <Badge className="bg-slate-900 text-white text-[7px] px-1 py-0.5 font-black uppercase tracking-widest rounded-sm w-full justify-center border-none">{coach.category}</Badge>
                                    </div>
                                    <div className="flex flex-col items-center justify-center text-center p-1 bg-white rounded-lg border border-slate-100 shadow-sm">
                                        <span className="text-slate-800 font-black text-[7px] uppercase flex items-center justify-center gap-1 bg-slate-50 px-1 py-0.5 rounded-sm w-full"><Star className="h-2 w-2 text-primary fill-primary" /> {coach.specialty || "Entraîneur"}</span>
                                    </div>
                                </div>
                            </div>
                        </section>
                    ...
                    <footer className="p-4 bg-slate-900 text-white flex flex-row justify-between items-end gap-4 text-left shrink-0 border-t border-primary mt-0">
                        <div className="space-y-0.5">
                            <div className="flex items-center gap-1 text-primary">
                                ...
                                <span className="text-[6px] font-black uppercase tracking-widest italic">Certification Digitale Certifiée</span>
                            </div>
