                ...
                <div id="printable-receipt" className="bg-white text-slate-900 border shadow-2xl flex flex-col" style={{ width: '600px' }}>
                    <header className="p-6 bg-slate-900 text-white flex flex-row justify-between items-center gap-4 border-b-4 border-primary">
                        ...
                        <div className="text-right space-y-0.5">
                            <h2 className="text-2xl font-black uppercase italic tracking-tighter text-white">REÇU</h2>
                            <div className="pt-0.5">
                                <p className="text-primary font-black text-[9px] tracking-[0.2em] uppercase">REF: {receiptRef}</p>
                                <p className="text-slate-500 text-[9px] font-bold">Date : {format(new Date(), "dd/MM/yyyy")}</p>
                            </div>
                        </div>
                    </header>
                    ...
                    <div className="px-8 py-6 space-y-8 flex-grow">
                        <div className="grid grid-cols-2 gap-6 text-left">
                            <div className="bg-slate-50 p-6 rounded-2xl border-2 border-slate-100 shadow-sm">
                                <h3 className="text-[8px] font-black uppercase tracking-[0.2em] text-slate-400 mb-4">Bénéficiaire (Joueur)</h3>
                                <div className="space-y-2">
                                    <p className="text-xl font-black text-slate-900 uppercase tracking-tighter">{payment.playerName}</p>
                                    <div className="flex flex-col gap-1.5">
                                        <p className="text-slate-600 font-bold text-xs">
                                            <span className="uppercase text-[7px] text-slate-400 font-black tracking-widest block">Catégorie</span> {payment.playerCategory}
                                        </p>
                            ...
                            <div className="bg-slate-50 p-6 rounded-2xl border-2 border-slate-100 shadow-sm">
                                <h3 className="text-[8px] font-black uppercase tracking-[0.2em] text-slate-400 mb-4">Motif du paiement</h3>
                                <div className="space-y-1">
                                    <p className="text-lg font-black text-slate-900 tracking-tight leading-tight">{payment.description}</p>
                            ...
                            <Table className="w-full">
                                <TableHeader className="bg-slate-100">
                                    <TableRow className="border-b-2 border-slate-200">
                                        <TableHead className="font-black text-slate-900 h-10 px-6 uppercase tracking-widest text-[8px]">Désignation</TableHead>
                                        <TableHead className="font-black text-slate-900 h-10 uppercase tracking-widest text-[8px]">Date</TableHead>
                                        <TableHead className="font-black text-slate-900 h-10 uppercase tracking-widest text-[8px]">Mode</TableHead>
                                        <TableHead className="text-right font-black text-slate-900 h-10 px-6 uppercase tracking-widest text-[8px]">Montant</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    ...
                                    <TableRow key={i} className="border-b border-slate-100 last:border-0 h-12 hover:bg-slate-50">
                                        <TableCell className="px-6 py-2 font-bold text-slate-900 text-xs">Versement N°{i+1}</TableCell>
                                        ...
                                        <TableCell className="text-right py-2 px-6 font-black text-slate-900 text-sm">{t.amount.toFixed(2)} MAD</TableCell>
                                    </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
                        ...
                        <div className="flex justify-end pt-2">
                            <div className="w-full max-w-[250px] space-y-3 bg-slate-900 p-6 rounded-2xl shadow-2xl text-left border-b-4 border-primary">
                                ...
                                <div className="flex justify-between text-slate-400 font-bold text-[8px] uppercase tracking-widest pt-0.5">
                    ...
                    <footer className="p-6 bg-slate-900 text-white flex justify-between items-center gap-4 mt-auto">
                        <div className="text-[8px] opacity-50 font-black uppercase tracking-widest text-left">
                            <p>© {new Date().getFullYear()} {clubInfo?.clubName || "Club Sportif"} - Team Assistant Pro</p>
                        </div>
                        <div className="text-primary font-black uppercase tracking-[0.2em] text-[8px] italic text-right border-l-2 border-primary/30 pl-4">
