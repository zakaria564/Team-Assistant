                ...
                <div id="printable-receipt" className="bg-white text-slate-900 border-none flex flex-col mx-auto overflow-hidden" style={{ width: '800px', minHeight: '1120px' }}>
                    <header className="p-12 bg-slate-900 text-white flex flex-row justify-between items-center gap-8">
                        ...
                        <div className="text-right space-y-2">
                            <h2 className="text-5xl font-black uppercase italic tracking-tighter text-white">REÇU</h2>
                            <div className="pt-2">
                                <p className="text-primary font-black text-sm tracking-[0.2em] uppercase">REF: {receiptRef}</p>
                                <p className="text-slate-500 text-xs font-bold mt-1">Date : {format(new Date(), "dd/MM/yyyy")}</p>
                            </div>
                        </div>
                    </header>
                    ...
                    <div className="p-14 space-y-12">
                        ...
                        <div className="rounded-2xl border-2 border-slate-200 shadow-xl overflow-hidden">
                            <Table className="w-full">
                                <TableHeader className="bg-slate-100">
                                    <TableRow className="border-b-2 border-slate-200">
                                        <TableHead className="font-black text-slate-900 h-14 px-8 uppercase tracking-widest text-[11px]">Désignation</TableHead>
                                        <TableHead className="font-black text-slate-900 h-14 uppercase tracking-widest text-[11px]">Date Versement</TableHead>
                                        <TableHead className="font-black text-slate-900 h-14 uppercase tracking-widest text-[11px]">Mode de règlement</TableHead>
                                        <TableHead className="text-right font-black text-slate-900 h-14 px-8 uppercase tracking-widest text-[11px]">Montant Versé</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    ...
                                    <TableRow key={i} className="border-b border-slate-100 last:border-0 h-16 hover:bg-slate-50">
                                        <TableCell className="px-8 py-5 font-bold text-slate-900 text-base">Versement N°{i+1}</TableCell>
                                        ...
                                        <TableCell className="text-right py-5 px-8 font-black text-slate-900 text-xl">{t.amount.toFixed(2)} MAD</TableCell>
                                    </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
                        ...
                        <div className="flex justify-end">
                            <div className="w-full max-w-sm space-y-4 bg-slate-900 p-8 rounded-2xl shadow-2xl text-left border-b-8 border-primary">
                                ...
                                <div className="flex justify-between text-slate-400 font-bold text-xs uppercase tracking-widest pt-2">
                    ...
                    <footer className="p-10 bg-slate-900 text-white flex justify-between items-center gap-6 mt-auto">
                        <div className="text-[10px] opacity-50 font-black uppercase tracking-widest text-left">
                            <p>© {new Date().getFullYear()} {clubInfo?.clubName || "Club Sportif"} - Team Assistant Pro</p>
                        </div>
                        <div className="text-primary font-black uppercase tracking-[0.3em] text-[10px] italic text-right border-l-2 border-primary/30 pl-6">
