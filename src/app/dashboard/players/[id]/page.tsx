...
import { Loader2, ArrowLeft, Shield, Star, Shirt, ClipboardList, Phone, Mail, Fingerprint, Cake, Flag, Home, User, VenetianMask, FileText, ExternalLink, Eye, Download } from "lucide-react";
...
export default function PlayerDetailPage(props: PageProps) {
  ...
  const birthDate = player.birthDate || undefined;
  const entryDate = player.entryDate || undefined;
